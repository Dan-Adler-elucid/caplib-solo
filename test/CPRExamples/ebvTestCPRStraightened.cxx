 ...
 */
// Parse arguments
void StaightenedVesselReformatTestParseArguments( int argc, char *argv[],
    std::string &CT,
    ...
    int &width )
{
    ...
    args.AddArgument(
        "--Output", argT::SPACE_ARGUMENT, &outFileName, "Result [defaults to StraightCPR.mha]");
...
int StraightenedVesselReformatTest(int argc, char *argv[])
{
    ...
    StaightenedVesselReformatTestParseArguments( argc, argv,
      ctaFileName,
    ...
    // type of cpr
    auto cprMode = ebv::mpr::VesselCenterline::CPRMode::CPRStraightenedMode;
    ...
    if (nThreads != -1)
    {
        cprFilter->SetNumberOfThreads(nThreads);
    }
    ...
    // Get traverser
    ebv::mpr::VesselTraverserStraightened *traverser =
        ebv::mpr::VesselTraverserStraightened::SafeDownCast(
